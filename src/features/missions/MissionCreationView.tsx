...
const requiredKeys = ["fieldBlockId", "cropBatchIds", "marketQuality", "plannedHarvestKg", "plannedDriedKg", "deadline"] as const;
type EditableFactKey = typeof requiredKeys[number] | "notes";
const labels: Record<string, string> = { fieldBlockId: "Field block", cropBatchIds: "Crop batches", marketQuality: "Market quality", plannedHarvestKg: "Planned harvest", plannedDriedKg: "Planned dried weight", deadline: "Deadline", availableWorkerCount: "Available workers", coveredDryingCapacityKg: "Covered drying capacity", notes: "Notes" };
