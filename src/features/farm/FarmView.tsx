...
export function FarmView({ data, onRefresh }: FarmViewProps) {
  ...
  return <div className="grid gap-6">
    ...
    <section className="grid gap-3 rounded-lg border border-destructive/30 bg-destructive/5 p-5" aria-labelledby="danger-zone-heading">
      <div><p className="text-xs font-bold uppercase tracking-[0.14em] text-destructive">Danger zone</p><h2 id="danger-zone-heading" className="mt-1 text-xl font-extrabold tracking-tight text-foreground">Delete this farm</h2><p className="mt-1 max-w-2xl text-sm leading-6 text-muted-foreground">This permanently deletes the farm, its field blocks, crop batches, missions, and connected Telegram and Calendar data. Your Google identity remains so you can sign in and onboard again.</p></div>
